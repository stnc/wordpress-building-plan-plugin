...
function stnc_wp_floor_MainMenu(){
 ...
 add_submenu_page( null, 'Kat', __( 'fixed map', 'the-stnc-map' ), 'manage_options', 'stnc_building_ext', 'stnc_wp_floor_adminMenu_stnc_building_ext',null ); ////burası alt kısım onun altında olacak olan bolum için 
