                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" st_trigger=new
                            href="/wp-admin/admin.php?page=stnc_building_company&st_trigger=new&binaid=<?php echo $_GET['binaid']?>&kat=<?php echo $_GET['kat']?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                        href="/wp-admin/admin.php?page=stnc_map_editor_building&st_trigger=show&teknoid=<?php echo $_GET['binaid']?>&id=<?php echo $_GET['kat']?>"><?php esc_html_e( 'Upload Map', 'the-stnc-map' ) ?></a>
                    </li>
