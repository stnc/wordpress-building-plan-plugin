...
function stnc_wp_floor_MainMenu(){
 ...
 add_submenu_page( "stnc_map_homepage", 'Kat',  __( 'Empty Buildings', 'the-stnc-map' ) , 'manage_options', 'stnc_empty_building_list', 'stnc_wp_floor_render_empty_list_page',null ); ////burası alt kısım onun altında olacak olan bolum için 
