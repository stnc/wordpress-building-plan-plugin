...
<?php foreach ($buildingsList as $building):
    ...
    <div class="grid-display element-item company<?php echo $building->company_category_id; ?> build<?php echo $building->building_id; ?>  ">
      ...
      <?php if ( current_user_can("editor") ||  current_user_can("administrator")) { ?>
          <a href="/wp-admin/admin.php?page=stnc_building_ext&binaid=1&kat=<?php echo $building->floor_id; ?>&st_trigger=show&id=<?php echo $building->id; ?>"><?php esc_html_e( 'edit', 'the-stnc-map' ) ?></a>
        <?php } ?>
            </div>
          </div>
      </div>
